...
${"|*disabled*|"}
`;class k extends(w(HTMLElement)){constructor(){super(),this.ids.btn.onclick=this.onclick}update_disabled(t){""===t?this.ids.btn.setAttribute("disabled",""):this.ids.btn.removeAttribute("disabled")}}customElements.define("btn-x",k);let v=s`
    <style>
        button {
            background-color: ${p};
            color : ${m};
...
`;l("delete-x",class extends k{constructor(){super(),this.ids.btn.innerHTML="x",this.swr.appendChild(v.content.cloneNode(!0))}});let E=i`
    <style>
        :host {
            contain: content; 
            display: block;
    ...
    <slot></slot>
`;customElements.define("title-x",class extends(E(HTMLElement)){});let z=i`
    <style>
        :host {
            contain: content; 
            display: block;
    ...
    <p><slot></slot></p>
`;l("subtitle-x",class extends(z(HTMLElement)){});let M=i`
    ${$}
    <slot></slot>
`;l("box-x",class extends(M(HTMLElement)){});let j=i`
    ${$}
    <style>
        :host{
...
`;l("message-x",class extends(j(HTMLElement)){})}]);